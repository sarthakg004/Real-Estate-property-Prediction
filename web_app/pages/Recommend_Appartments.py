...
cosine_sim1 = pickle.load(open('web_app/datasets/cosine_sim1.pkl','rb'))
cosine_sim2 = pickle.load(open('web_app/datasets/cosine_sim2.pkl','rb'))
cosine_sim3 = pickle.load(open('web_app/datasets/cosine_sim3.pkl','rb'))

location_df = pickle.load(open('web_app/datasets/location_df.pkl','rb'))
